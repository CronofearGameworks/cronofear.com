---
title: "Installation"
permalink: /docs-level-makr-kit/installation/
...
**1.** For a **new site**, install the `minimal-mistakes-jekyll` theme gem or fork the Minimal Mistakes repo on GitHub following the steps outlined in the [*Quick-Start Guide*]({{ "/docs-level-makr-kit/quick-start-guide/" | absolute_url }}).
...
**2.** For an **existing site** follow the steps outlined in the [*Quick-Start Guide*]({{ "/docs-level-makr-kit/quick-start-guide/" | absolute_url }}). Then work through the guidelines below for migration and setup.
...
[**Front Matter defaults**](https://jekyllrb.com/docs-level-makr-kit/configuration/#front-matter-defaults) are your friend and I encourage you to leverage them instead of setting a layout and other global options in each post/page's YAML Front Matter.
...
If this is your first time using Jekyll be sure to read through the [official documentation](https://jekyllrb.com/docs-level-makr-kit/home/) before jumping in. This guide assumes you have Ruby v2 installed and a basic understanding of how Jekyll works.
